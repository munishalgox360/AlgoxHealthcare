const registerTemplate = (content) => {
  const { email, phone, displayName, uid, gender, dateOfBirth } = content;
  ...
  return `
        ...
        <body class="email">
            <div class="email__container">
                ...
                <main>
                    <p class="email__p">
                        ${displayName} registered successfully at Psymate Clinic through our exclusive portal. 
                    </p>
                    <p class="email__p">
                    ...
                    <div class="email__p">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td>Email</td>
                                    <td class="table__detail">${email} </td>
                                </tr>
                                <tr>
                                <td>Phone Number</td>
                                <td class="table__detail">${phone} </td>
                            </tr>
                                <tr>
                                    <td>Date Of birth Name</td>
                                    <td class="table__detail">${dateOfBirth}</td>
                                </tr>
                                <tr>
                                    <td>Gender</td>
                                    <td class="table__detail">${gender}</td>
                                </tr>
                                <tr>
                                    <td>Unique ID</td>
                                    <td class="table__detail">
                                        <span>${uid}</span>
                                        <span class="table__paid">Generated</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <p class="email__p">
                        <a href="https://master.d2cdj2c7l1kjh2.amplifyapp.com/patients" class="email__cta">See all users</a>
                    </p>
                </main>
